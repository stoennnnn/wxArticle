...
CREATE TABLE `wechat_article` (
  `articl_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `article_datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '发行时间',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`articl_id`),
...
-- ----------------------------
INSERT INTO `wechat_article` VALUES ('1', '1', '我们都来学java', 'java学习公众号', 'www.baidu.com', 'www.baidu.com', '1970-01-18 00:00:00', '2019-02-11 16:40:32', '2019-02-11 16:40:32');
